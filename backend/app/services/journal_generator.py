...
class JournalGenerator:
    ...
    def generate_journal(
        ...
        tds_applicable = tds_data.get("tds_applicable") or tds_data.get("is_applicable") or tds_data.get("applicable")
        ...
        tds_section = tds_data.get("tds_section") or tds_data.get("section") or "194C"
